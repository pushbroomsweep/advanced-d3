async function drawBars() {
  ...
  const drawHistogram = (metric) => {
    ...
    const updateTransition = exitTransition.transition().duration(600); //.ease(d3.easeBackIn);
    ...
    newBinGroups
      .append("rect")
      .attr("height", 0) // the following is required to prevent flying in from the origin
    ...
    newBinGroups
      .append("text") // the following is required to prevent flying in from the origin
